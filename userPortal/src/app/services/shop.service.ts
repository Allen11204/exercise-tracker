...
export class ShopService {
  ...
  // Comment APIs
  addComment(itemId: number, userId: number, commentText: string): Observable<Comment> {
    return this.http.post<Comment>(`${this.baseUrl}/items/${itemId}/comments`, { userId, commentText });
  }

  getComments(itemId: number): Observable<Comment[]> {
    return this.http.get<Comment[]>(`${this.baseUrl}/items/${itemId}/comments`);
  }
}
